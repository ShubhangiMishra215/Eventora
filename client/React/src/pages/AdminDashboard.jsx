                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mb-8 animation-slideDown">
                    ...
                    <form onSubmit={handleCreateEvent} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-2">
                            <input type="text" placeholder="Image URL (Provide any direct link to an image)" className="w-full border px-4 py-3 rounded-lg focus:ring-2 focus:ring-gray-700 outline-none transition" value={formData.imageUrl} onChange={e => setFormData({ ...formData, imageUrl: e.target.value })} />                        </div>
                                        ...
                                        {booking.status === 'pending' && (
                                            <div className="flex flex-wrap gap-2 mt-2">
                                                <button 
                                                    ...
                                                    className="flex-1 min-w-[120px] bg-green-50 text-green-700 hover:bg-green-600 hover:text-white border border-green-200 text-xs font-bold py-2.5 px-3 rounded-lg shadow-sm transition disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
                                                    ✓ Approve as Paid
                                                </button>
                                                <button 
                                                    ...
                                                    disabled={processingId === booking._id}
                                                    className="flex-1 min-w-[120px] bg-gray-50 text-gray-700 hover:bg-gray-800 hover:text-white border border-gray-200 text-xs font-bold py-2.5 px-3 rounded-lg shadow-sm transition disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
                                                    ✓ Approve Undecided
                                                </button>
                                                <button 
                                                    ...
                                                    disabled={processingId === booking._id}
                                                    className="w-[80px] bg-red-50 text-red-600 hover:bg-red-500 hover:text-white border border-red-200 text-xs font-bold py-2.5 px-3 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
                                                    ✕ Reject
                                                </button>
                                            </div>
